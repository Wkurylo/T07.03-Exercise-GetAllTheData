...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        WaitlistDbHelper waitlistDbHelper = new WaitlistDbHelper(MainActivity.this);
        ...
        Cursor dataCursor = getAllGuests();
        // completed (12) Pass the resulting cursor count to the adapter
        // Create an adapter for that cursor to display the data
        mAdapter = new GuestListAdapter(this, dataCursor.getCount() );
    ...
    private Cursor getAllGuests (){
        Cursor cursor = mDb.query(WaitlistContract.WaitlistEntry.TABLE_NAME, null,null,null,null,null, WaitlistContract.WaitlistEntry.COLUMN_TIMESTAMP);
        return cursor;
    }
